...
\begin{proc}{caminoMinimo}{\In origen : \ent, \In destino: \ent, \In distancias: \TLista{\TLista{\ent}}}{\TLista{\ent}}
    ...
    \asegura{\neg \existe[unalinea]{\ camino}{\TLista{\ent}}{esCamino(distancias,origen,destino,camino) \land \\
    \paraTodo[unalinea]{\ otroCamino}{\TLista{\ent}}{esCamino(distancias,origen,destino,otroCamino) \implicaLuego \\
    longitudDeCamino(camino,distancias) \leq longitudDeCamino(otroCamino,distancias)}} \implicaLuego res = <>}
    \asegura{\existe[unalinea]{\ camino}{\TLista{\ent}}{esCamino(distancias,origen,destino,camino) \land \\
    \paraTodo[unalinea]{\ otroCamino}{\TLista{\ent}}{esCamino(distancias,origen,destino,otroCamino) \implicaLuego \\
    longitudDeCamino(camino,distancias) \leq longitudDeCamino(otroCamino,distancias)}} \implicaLuego res = camino}
